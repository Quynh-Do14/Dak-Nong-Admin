...
export const ListRestaurantManagement = () => {
    ...
    const [categoryId, setCategoryId] = useState(Constants.CategoryConfig.Restaurant.value);
    ...
    const onSearch = async (keyWord = "", limit = pageSize, page = 1, idQuanHuyen = dataDistrict[0]?.idQuanHuyen, idDanhMuc = Constants.CategoryConfig.Restaurant.value) => {
